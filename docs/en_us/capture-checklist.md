...
## Weekly Absorb / Rally Screens

Capture the following templates with a `1280x720` client area:

- Bottom-right home game cassette entry: `resource/image/weekly/game_cassette_entry.png`
- Story game tab/card in the cassette list: `resource/image/weekly/story_game_tab.png`
- Story cassette: `resource/image/weekly/cassette_07.png`
- Story cassette: `resource/image/weekly/cassette_08.png`
- Story cassette: `resource/image/weekly/cassette_09.png`
- Story cassette: `resource/image/weekly/cassette_13.png`
- Story cassette: `resource/image/weekly/cassette_16.png`
- Story cassette: `resource/image/weekly/cassette_17.png`
- Explore icon: `resource/image/weekly/action_explore.png`
